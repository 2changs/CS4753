        ...
        <div id="page-wrapper">
            ...
            <section id="banner">
                <div class="inner" style="text-align: center;">
                    ...
                    <p>You are about to purchase the Pro plan. Click the button below to proceed!</p>
                    <form class="logo" action="https://test.bitpay.com/checkout" method="post" >
                        <input type="hidden" name="action" value="checkout" />
                        <input type="hidden" name="posData" value="" />
                        <input type="hidden" name="data" value="eKH0j0sYXbTiSddl+h3PM5bAcb49nb+HWkkAPGXP5k1GY065wZ2prBo5uL2LwTHf5V67c1hx6ilIFEQ1XPfO2LIv5NLcCxdBncEmEU8eJVeJzMHnIFmcoBaxH5G7+qnkDEEtUpTucp38Wl92ziXuMg8eWN/wO+AmZzBDqDWWgYbBxJkANupidgbQJL2q7qPo" />
