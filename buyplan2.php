        ...
        <div id="page-wrapper">
            ...
            <section id="banner">
                <div class="inner" style="text-align: center;">
                    ...
                    if ($_SESSION['loggedin'] == true) {
                    ?>
                    <p>You are about to purchase the Plus plan. Click the button below to proceed!</p>
                    ...
                    ?>
                    <p>Interested in purchasing the Plus plan? <a href="login.php"> Sign in</a> or <a href="register.php"> create an account</a> today!</p>
                    <?php
                    }
                    ?>
                </div>
